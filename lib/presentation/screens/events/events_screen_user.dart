...
class EventScreenUserState extends ConsumerStatefulWidget {
  const EventScreenUserState({super.key});

  @override
  ConsumerState<EventScreenUserState> createState() => __EventScreenUserStateState();
}

class __EventScreenUserStateState extends ConsumerState<EventScreenUserState> {
